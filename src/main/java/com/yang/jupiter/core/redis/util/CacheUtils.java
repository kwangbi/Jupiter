package com.yang.jupiter.core.redis.util;

import javax.annotation.PostConstruct;

import com.yang.jupiter.core.redis.CacheConstants;
import com.yang.jupiter.core.redis.cache.service.CommonCacheService;
...
public class CacheUtils {
    ...
    public static Object getCacheData(final String metaSet, final String id) {
        return getCacheData(metaSet, id, CacheConstants.RedisType.RS1);
    }
    ...
    public static <T> T getCacheData(final String metaSet, final String id, final Class<T> clazz) {
        return getCacheData(metaSet, id, clazz, CacheConstants.RedisType.RS1);
    }
